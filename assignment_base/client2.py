...
data = sftp.listdir('/home/camera1/Public/Footage/')
...
def encrypt_picture(picture: bytes) -> bytes:
    """This function encrypts the image returned by get_picture.  It will return 0 byte if no motion is detected.
    Args:
        picture (bytes): the image returned by get_picture
    Returns:

...
privatekeyfile = 'camera2\id_rsa.ppk'
mykey = paramiko.RSAKey.from_private_key_file(privatekeyfile)
transport = paramiko.Transport(('192.168.242.146', 22))
transport.connect(username = 'camera2', pkey = mykey)
...
while True: # Main function
    try:  
        ...
        if len(image) == 0:
            ...
            remoteFilePath = '/home/camera2/Public/Footage/' + fileName
